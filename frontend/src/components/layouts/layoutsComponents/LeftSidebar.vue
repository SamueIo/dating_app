<template>
    <aside
      :class="{
        'w-full p-2 bg-black/10 text-white border-r border-white/10 max-h-[calc(100vh-30px)] overflow-y-auto': isMobile,
        'w-1/5 p-2 bg-black/10 text-white border-r border-white/10': !isMobile
      }"
    >
