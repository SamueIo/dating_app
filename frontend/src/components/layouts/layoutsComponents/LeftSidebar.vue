<template>
    <aside
      :class="{
        'w-full p-2 bg-black/10 text-white border-r border-white/10 max-h-[calc(100vh-50px)] overflow-y-auto': isMobile,
        'w-1/5 p-2 bg-black/10 text-white border-r border-white/10   overflow-y-auto': !isMobile
      }"
    >
